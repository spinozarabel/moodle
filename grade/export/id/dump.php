...
require_once($CFG->dirroot.'/grade/export/id/grade_export_id.php');
...
require_capability('gradeexport/id:publish', $context);
...
$export = new grade_export_id($course, $groupid, $formdata);
$export->print_grades();
